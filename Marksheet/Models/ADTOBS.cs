...
namespace Marksheet.Models
{
    public class ADTOBS
    {
        ...
        public static bool IsRangeEng(int yy, int mm, int dd)
        {
            if (yy < 1944 || yy > 2033)
            {
                Console.WriteLine("Supported only between 1944-2022");
                return false;
            }

            if (mm < 1 || mm > 12)
            {
                Console.WriteLine("Error! value 1-12 only");
                return false;
            }

            if (dd < 1 || dd > 31)
            {
                Console.WriteLine("Error! value 1-31 only");
                return false;
            }
        ...
        public static bool IsYearRangeNep(int yy)
        {
            if (yy < 2000 || yy > 2089)
            {
                Console.WriteLine("Supported only between 2000-2089");
                return false;
            }
            return true;
        }
