...
namespace Marksheet.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StudentName,Address,FatherName,MotherName,Phone,DOB,SymbolNo,Sex,Class,Mobile,SchoolId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StudentName,Address,FatherName,MotherName,Sex,SymbolNo,Class,Phone,DOB,Mobile,SchoolId")] Student student)
        {
            if (ModelState.IsValid)
            {
